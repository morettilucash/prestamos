...
export class NombreMigracion1593104460527 implements MigrationInterface {
    name = 'NombreMigracion1593104460527'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pagos" ("id" SERIAL NOT NULL, "monto" real NOT NULL, "fecha_hora" TIMESTAMP NOT NULL, "nro_cuota" integer NOT NULL, "prestamoIdId" integer, CONSTRAINT "PK_37321ca70a2ed50885dc205beb2" PRIMARY KEY ("id"))`, undefined);
