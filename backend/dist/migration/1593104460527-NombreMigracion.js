...
class NombreMigracion1593104460527 {
    constructor() {
        this.name = 'NombreMigracion1593104460527';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE "pagos" ("id" SERIAL NOT NULL, "monto" real NOT NULL, "fecha_hora" TIMESTAMP NOT NULL, "nro_cuota" integer NOT NULL, "prestamoIdId" integer, CONSTRAINT "PK_37321ca70a2ed50885dc205beb2" PRIMARY KEY ("id"))`, undefined);
...
exports.NombreMigracion1593104460527 = NombreMigracion1593104460527;
//# sourceMappingURL=1593104460527-NombreMigracion.js.map