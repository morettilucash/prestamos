...
class NombreMigracion1593140416030 {
    constructor() {
        this.name = 'NombreMigracion1593140416030';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE "pagos" ("id" SERIAL NOT NULL, "monto" real NOT NULL, "ganancia" real NOT NULL, "fecha_hora" TIMESTAMP NOT NULL, "nro_cuota" integer NOT NULL, "prestamoIdId" integer, CONSTRAINT "PK_37321ca70a2ed50885dc205beb2" PRIMARY KEY ("id"))`, undefined);
...
exports.NombreMigracion1593140416030 = NombreMigracion1593140416030;
//# sourceMappingURL=1593140416030-NombreMigracion.js.map